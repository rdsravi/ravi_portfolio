...
const List<_AccountData> _accounts = [
  _AccountData(
    ...
    type: 'Flutter, Dart, Firebase, Github',
    balance: 'Charges: \$--',
    cardNumber: '24*7 Technical support',
  ...
  _AccountData(
    ...
    type: 'HTML, CSS, Javascript, JQuery, Flutter, Firebase',
    balance: 'Charges: \$--',
    cardNumber: '24*7 Technical support',
  ...
  _AccountData(
    ...
    type: 'Youtube ads, Facebook ads & all social ads',
    balance: 'Charges: \$--',
    cardNumber: '24*7 Technical support',
